...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonCol, IonGrid, IonCardHeader, IonChip, IonCard, IonRow } from '@ionic/angular/standalone';
...
export class ConstructorsPage implements OnInit {
  ...
  //       this.constructors_championship = response.constructors_championship.sort((a, b) => a.position - b.position);
  //     },
  //     error: (err) => {
